...
// Corrected: Express route to fetch dealer by a particular id (using 'id' field, not '_id')
app.get('/fetchDealer/:id', async (req, res) => {
  try {
    const dealership = await Dealerships.findOne({ id: req.params.id });  // Look for 'id' field
    if (!dealership) {
